...
module e203_cpu #(
  ...
  wire core_dec_active;
  wire core_exu_active;
  wire core_wbck_active;
  ...
  e203_clk_ctrl u_e203_clk_ctrl(
    ...
    .clk_core_dec (clk_core_dec      ),
    .clk_core_exu (clk_core_exu      ),
    .clk_core_wbck (clk_core_wbck      ),
  ...
  `endif
    ...
    .core_dec_active(core_dec_active),
    .core_exu_active(core_exu_active),
    .core_wbck_active(core_wbck_active),
  ...
  `endif//}
    ...
    .dec_active              (core_dec_active),
    .exu_active              (core_exu_active),
    .wbck_active              (core_wbck_active),
