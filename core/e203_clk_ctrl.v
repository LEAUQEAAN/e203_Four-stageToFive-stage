...
module e203_clk_ctrl (
  ...
  input  core_dec_active,
  input  core_exu_active,
  input  core_wbck_active,
  ...
  wire dec_clk_en = core_cgstop | (core_dec_active);
  ...
  wire wbck_clk_en = core_cgstop | (core_wbck_active);
  ...
  e203_clkgate u_dec_clkgate(
    .clk_in   (clk        ),
    .test_mode(test_mode  ),
    .clock_en (dec_clk_en),
    .clk_out  (clk_core_dec)
  );
  ...
  e203_clkgate u_wbck_clkgate(
    .clk_in   (clk        ),
    .test_mode(test_mode  ),
    .clock_en (wbck_clk_en),
    .clk_out  (clk_core_wbck)
  );
