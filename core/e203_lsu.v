...
module e203_lsu(
  ...
  output lsu_alu_wbck_o_valid,
  input lsu_alu_wbck_o_ready,
  output [`E203_XLEN-1:0] lsu_alu_wbck_o_wdat,
  output [`E203_RFIDX_WIDTH-1:0] lsu_alu_wbck_o_rdidx,
  ...
  wire lsu_o_valid_nxt; // Handshake valid
  wire [`E203_XLEN-1:0] lsu_o_wbck_wdat_nxt;
  wire [`E203_ITAG_WIDTH -1:0] lsu_o_wbck_itag_nxt;
  wire lsu_o_wbck_err_nxt; 
  wire lsu_o_cmt_ld_nxt;
  wire lsu_o_cmt_st_nxt;
  wire [`E203_ADDR_SIZE -1:0] lsu_o_cmt_badaddr_nxt;
  wire lsu_o_cmt_buserr_nxt ; // The bus-error exception generated
  ...
  `endif//}
    .lsu_o_valid           (lsu_o_valid_nxt ),
    .lsu_o_ready           (lsu_o_ready ),
    .lsu_o_wbck_wdat       (lsu_o_wbck_wdat_nxt),
    .lsu_o_wbck_itag       (lsu_o_wbck_itag_nxt),
    .lsu_o_wbck_err        (lsu_o_wbck_err_nxt  ),
    .lsu_o_cmt_buserr      (lsu_o_cmt_buserr_nxt  ),
    .lsu_o_cmt_badaddr     (lsu_o_cmt_badaddr_nxt ),
    .lsu_o_cmt_ld          (lsu_o_cmt_ld_nxt ),
    .lsu_o_cmt_st          (lsu_o_cmt_st_nxt ),
  ...
  assign lsu_alu_wbck_o_valid  = alu_wbck_i_valid; 
  assign alu_wbck_i_ready =  lsu_alu_wbck_o_ready;
  assign lsu_alu_wbck_o_wdat   =  alu_wbck_i_wdat;
  assign lsu_alu_wbck_o_rdidx  = alu_wbck_i_rdidx;

  assign lsu_o_valid = lsu_o_valid_nxt;  
  assign lsu_o_wbck_wdat = lsu_o_wbck_wdat_nxt;
  assign lsu_o_wbck_itag = lsu_o_wbck_itag_nxt;
  assign lsu_o_wbck_err = lsu_o_wbck_err_nxt; 
  assign lsu_o_cmt_ld = lsu_o_cmt_ld_nxt;
  assign lsu_o_cmt_st = lsu_o_cmt_st_nxt;
  assign lsu_o_cmt_badaddr = lsu_o_cmt_badaddr_nxt;
  assign lsu_o_cmt_buserr = lsu_o_cmt_buserr_nxt ; 

  assign lsu_active = lsu_ctrl_active | excp_active;
endmodule
